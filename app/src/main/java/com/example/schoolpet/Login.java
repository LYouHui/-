...
public class Login extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        userName = (AutoCompleteTextView) findViewById(R.id.editText_userNumber);
        ...
        toRegister=(Button)findViewById(R.id.login_button_toregister);
        ...
        signIn.setOnClickListener(new View.OnClickListener(){
            public void onClick(View v) {
                ...
                String m_password = mPasswordView.getText().toString().trim();
                ...
                bu2.login(new SaveListener<BmobUser>() {
                    public void done(BmobUser bmobUser, BmobException e) {
                        if(e==null){
                            Intent intent=new Intent(Login.this,PetPage.class);
                            startActivity(intent);
                            //通过BmobUser user = BmobUser.getCurrentUser()获取登录成功后的本地用户信息
                            //如果是自定义用户对象MyUser，可通过MyUser user = BmobUser.getCurrentUser(User.class)获取自定义用户信息
                        }else{
                            createDialog("登录失败","请检查账户密码的一致性，若仍无法登录，请联系客服" );
                        }
                    }
                });
            }
    ...
    /*private void fun1() throws IOException{
        Socket socket=new Socket("127.0.0.1",30303);
        BufferedReader br=new BufferedReader(new InputStreamReader(socket.getInputStream()));
        String line=br.readLine();
        Toast toast=Toast.makeText(Login.this, line ,Toast.LENGTH_LONG);
